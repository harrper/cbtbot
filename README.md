...
Дневник за день хранит дату внесения, исходный текст, явно названный день
записи, краткое содержание, эмоциональное состояние, время отхода ко сну,
время пробуждения и длительность сна в часах. Если день, эмоциональная оценка или
одно из времён сна не названы, бот попросит уточнение.
