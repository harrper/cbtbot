                ...
                "content": [
                    {
                        ...
                        "text": (
                            ...
                            "Можно убрать только явные оговорки, самоповторы, слова-паразиты и обрывки "
                            "фраз, которые не добавляют смысла. Нельзя заменять цепочку мыслей кратким "
                            "обобщением или более красивой формулировкой. Если пользователь перечислил "
                            "несколько мыслей, сохрани каждую прямо названную мысль, а не общий вывод. "
                            ...
                            "в thoughts, если они прямо сказаны. Thoughts — это не краткое резюме, а почти "
                            "дословный список прямо названных автоматических мыслей, прогнозов, оценок, "
                            "сомнений и выводов пользователя. Сохраняй порядок мыслей из исходного текста "
                            "и не объединяй несколько мыслей в одну обобщенную фразу. "
                            ...
                            "пустым. Действия — только явно указанные действия, которые пользователь "
                            "предпринял после появления эмоций/мыслей, или явно указанные следующие "
                            "планируемые действия. Не записывай в actions событие-триггер или контекст, "
